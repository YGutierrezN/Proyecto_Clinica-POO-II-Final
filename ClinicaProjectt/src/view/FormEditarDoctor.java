 ...
 * @author Jx
 */
public class FormEditarDoctor extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FormAddDoctor
     */
    public FormEditarDoctor() {
        initComponents();
    ...
    public void PasarObjeto(Doctor ObjDoc)
    {
        this.Id = ObjDoc.getId();
        this.nom = ObjDoc.getNombre();
        this.contra = ObjDoc.getEspecialidad();
        
        txtID.setText(ObjDoc.getId());
        txtNombre.setText(ObjDoc.getNombre());
        
        ComboEspecialidad.setSelectedItem(ObjDoc.getEspecialidad());
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/editDoctor.png"))); // NOI18N
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        ...
        if (msg == JOptionPane.YES_OPTION)
        {
            ...
            docCon.updateDoctorController(doc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditarDoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEditarDoctor().setVisible(true);
            }
        });
    }
