...
public class FormAddUsuario extends javax.swing.JFrame {
    ...
    {
        int tamaño = usuCon.getAllUsuariosController().size() + 1;
        txtUsuario.setText(String.valueOf(tamaño));
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/addUsuario.png"))); // NOI18N
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        int msg = JOptionPane.showConfirmDialog(BtnAgregar,"Desea agregar el usuario??","AGREGAR",JOptionPane.YES_NO_OPTION);
        if (msg == JOptionPane.YES_OPTION)
        {
            Usuario usu = new Usuario();
            
            usu.setId(txtUsuario.getText());
            usu.setNombre(txtNombre.getText());
            usu.setContraseña(txtContra.getText());
            usu.setTipo(ComboTipo.getSelectedItem().toString());
            
            usuCon.addUsuarioController(usu);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAddUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAddUsuario().setVisible(true);
            }
        });
    }
