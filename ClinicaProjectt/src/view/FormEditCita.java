 ...
 * @author Jx
 */
public class FormEditCita extends javax.swing.JFrame {

    CitaController citCon = new CitaController();
    
     private String Id, pac, fecha;
    ...
    public void PasarObjeto(Cita ObjCita)
    {
        this.Id = ObjCita.getId();
        this.pac = ObjCita.getNom_paciente();
        this.fecha = ObjCita.getFecha();
        
        
        txtID.setText(ObjCita.getId());
        txtFecha.setText(ObjCita.getFecha());
        txtPaciente.setText(ObjCita.getNom_paciente());
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        ...
        int msg = JOptionPane.showConfirmDialog(BtnAgregar,"Desea editar la cita??","EDITAR",JOptionPane.YES_NO_OPTION);
        if (msg == JOptionPane.YES_OPTION)
        {
            ...
            citCon.updateCitaController(cit);
...
comboDoctor.addItem("Seleccione...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditCita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEditCita().setVisible(true);
            }
        });
    }
