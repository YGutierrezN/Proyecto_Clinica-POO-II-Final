 ...
 * @author Jx
 */
public class FormAddPaciente extends javax.swing.JFrame {
    ...
    {
        int tamaño = pacCon.getAllPacientesController().size() + 1;
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        int msg = JOptionPane.showConfirmDialog(BtnAgregar,"Desea agregar el paciente??","AGREGAR",JOptionPane.YES_NO_OPTION);
        if (msg == JOptionPane.YES_OPTION)
        {
            ...
            pacCon.addPacienteController(pac);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAddPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAddPaciente().setVisible(true);
            }
        });
    }
