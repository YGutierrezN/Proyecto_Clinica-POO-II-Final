 ...
 * @author Jimx
 */
public class loginMantenimiento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextoBienvenida.setText("Administrador");
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/mant.png"))); // NOI18N
    ...
    private void BtnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIngresarActionPerformed
        ...
        usuarioCon.ValidarMantenimientoController(txtUsuario, txtContraseña);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginMantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new loginMantenimiento().setVisible(true);
            }
        });
    }
